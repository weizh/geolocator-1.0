...
wget -P lib/ http://repo1.maven.org/maven2/org/apache/lucene/lucene-core/3.6.2/lucene-core-3.6.2.jar

wget -P lib/ http://repo1.maven.org/maven2/org/apache/lucene/lucene-analyzers/3.1.0/lucene-analyzers-3.1.0.jar
